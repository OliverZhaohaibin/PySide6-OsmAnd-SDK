...
QString OsmAnd::IMapRenderer_Metrics::Metric_update::toString(const bool shortFormat /*= false*/, const QString& prefix /*= QString()*/) const
{
    QString output;
...
QString OsmAnd::IMapRenderer_Metrics::Metric_prepareFrame::toString(const bool shortFormat /*= false*/, const QString& prefix /*= QString()*/) const
{
    QString output;
...
QString OsmAnd::IMapRenderer_Metrics::Metric_renderFrame::toString(const bool shortFormat /*= false*/, const QString& prefix /*= QString()*/) const
{
    QString output;
