...
OsmAnd::ResourcesManager::ResourcesManager(
    ...
    const QString& userStoragePath_ /*= QString()*/,
    const QList<QString>& readonlyExternalStoragePaths_ /*= QList<QString>()*/,
    const QString& miniBasemapFilename_ /*= QString()*/,
    const QString& localTemporaryPath_ /*= QString()*/,
    const QString& hiddenMapsPath_ /*= QString()*/,
    const QString& localCachePath_ /*= QString()*/,
    const QString& appVersion_ /*= QString()*/,
...
OsmAnd::ResourcesManager::ResourceType OsmAnd::ResourcesManager::getIndexType(const QStringView resourceTypeValue)
{
