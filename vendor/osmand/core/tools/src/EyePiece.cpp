...
#endif
{
    ...
    const auto wglExtensions = QString::fromLatin1(wglExtensionsString).split(QRegularExpression(QStringLiteral("\\s+")), Qt::SkipEmptyParts);
    ...
    const auto glxExtensions = QString::fromLatin1(glxExtensionsString).split(QRegularExpression(QStringLiteral("\\s+")), Qt::SkipEmptyParts);
    if (configuration.verbose)
    ...
    const auto glxClientExtensions = QString::fromLatin1(glxClientExtensionsString).split(QRegularExpression(QStringLiteral("\\s+")), Qt::SkipEmptyParts);
    if (configuration.verbose)
    ...
    const auto glxServerExtensions = QString::fromLatin1(glxServerExtensionsString).split(QRegularExpression(QStringLiteral("\\s+")), Qt::SkipEmptyParts);
    if (configuration.verbose)
