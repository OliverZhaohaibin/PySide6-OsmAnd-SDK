...
# ``DEFAULT_MAX_TILE_ZOOM_LEVEL`` reflects the highest tile zoom level expected
# from the bundled OsmAnd helper output. Backends can override this value at
# render time via ``compute_view_state(..., max_tile_zoom_level=...)``.
