    ...
    AlphaChannelType &currentAlphaChannelType)
{
    ...
    {
        const auto glyphsToDraw = qMin<qsizetype>(glyphsCount - glyphsDrawn, static_cast<qsizetype>(_onPathSymbol2dMaxGlyphsPerDrawCall));
    ...
    AlphaChannelType &currentAlphaChannelType)
{
    ...
    while (glyphsDrawn < glyphsCount)
    {
        const auto glyphsToDraw = qMin<qsizetype>(glyphsCount - glyphsDrawn, static_cast<qsizetype>(_onPathSymbol3dMaxGlyphsPerDrawCall));
        auto pGlyphVS = pFirstGlyphVS;
