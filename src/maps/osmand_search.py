...
_PLUGIN_GEONAMES_DB_PATH = Path(__file__).resolve().parents[2] / "plugin" / "data" / "geonames.sqlite3"
...
class GeoNamesSearchService:
    ...
    def __init__(self, database_path: Path | None = None) -> None:
        self._database_path = (database_path or _PLUGIN_GEONAMES_DB_PATH).resolve()
