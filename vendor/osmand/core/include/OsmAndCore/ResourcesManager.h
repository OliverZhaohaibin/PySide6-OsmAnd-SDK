...
namespace OsmAnd
{
    ...
    public:
        ...
        // Local resources:
        bool rescanUnmanagedStoragePaths(bool rescanAll = false) const;
        ...
        static OsmAnd::ResourcesManager::ResourceType getIndexType(const QStringView resourceTypeValue);
    };
}
