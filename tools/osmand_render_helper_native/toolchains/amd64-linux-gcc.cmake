# Linux toolchain file for osmand_render_helper_native
# This configures the build for native Linux amd64 with GCC/Clang

set(CMAKE_SYSTEM_NAME Linux)
set(CMAKE_SYSTEM_PROCESSOR x86_64)

# OsmAnd target settings
...
elseif(CMAKE_CXX_COMPILER_ID MATCHES "GNU")
    ...
    message(WARNING "Unknown compiler family: ${CMAKE_CXX_COMPILER_ID}, defaulting to clang")
    set(CMAKE_COMPILER_FAMILY clang)
endif()

# Compiler flags for 64-bit Linux
set(CMAKE_ASM_FLAGS "-m64 -fPIC")
set(CMAKE_C_FLAGS "-m64 -fPIC")
set(CMAKE_CXX_FLAGS "-m64 -fPIC")

# RPATH settings for finding libraries relative to executable
...
message(STATUS "Linux toolchain configured for ${CMAKE_COMPILER_FAMILY} compiler")
