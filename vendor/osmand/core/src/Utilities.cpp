...
/**
 * Returns the destination point having travelled along a rhumb line from â€˜thisâ€™ point the given
 ...
 *
 * @example
 *     rhumbDestinationPoint(LatLon(51.127, 1.338), 40300, 116.7); // 50.9642Â°N, 001.8530Â°E
 */
