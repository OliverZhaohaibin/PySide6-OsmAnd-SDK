...
#if (defined(WIN32) || defined(_WIN32) || defined(__WIN32__))
    _putenv_s("TZ", ""); // daylight saving off fix testOpened("23.07.2019 04:00", hours, false);
    _tzset();
#else
...
void OpeningHoursParser::runTestAmPmChinese() {
    ...
    // TODO: Fixme
	//testParsedAndAssembledCorrectly("Mon-Fri Ã¤Â¸Å Ã¥ÂË†4:30-10:00, Ã¤Â¸Å Ã¥ÂË†7:30-Ã¤Â¸â€¹Ã¥ÂË†11:00; Sat, Sun, PH Ã¤Â¸â€¹Ã¥ÂË†1:30-11:00", hours, true);
...
void OpeningHoursParser::runTestAmPmArabic() {
	...
	std::string string = "Mo-Fr 04:30-10:00, 07:30-23:00; Sa, Su, PH 13:30-23:00";
	auto hours = parseOpenedHours(string);
	testParsedAndAssembledCorrectly("Mon-Fri Ã™Â¤:Ã™Â£Ã™Â -Ã™Â¡Ã™Â :Ã™Â Ã™Â Ã‚Â Ã˜Âµ, Ã™Â§:Ã™Â£Ã™Â Ã‚Â Ã˜Âµ-Ã™Â¡Ã™Â¡:Ã™Â Ã™Â Ã‚Â Ã™â€¦; Sat, Sun, PH Ã™Â¡:Ã™Â£Ã™Â -Ã™Â¡Ã™Â¡:Ã™Â Ã™Â Ã‚Â Ã™â€¦", hours, true);
